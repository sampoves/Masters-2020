...
%%% TBstrut is also defined in the preamble of the main document. See following address for the full explanation:
...
\begin{tabularx}{\linewidth}{|S{X}S{X}|S{X}|S{X}|S{X}|S{X}|}
    ...
    \multicolumn{6}{?>{\hsize=\dimexpr6\hsize+10\tabcolsep\relax} S{X}?} {\textsf{Tiivistelmä/Referat – Abstract} \myabstract} \\ [540pt]
    \hline
