...
This thesis employs \acrshort{ppgis} in its parking research, approaching the subject matter with a \textit{do-it-yourself} mentality. While \citeintext{Salonen2014} expected low response rate for their survey research, this thesis aims to demonstrate that extensive scientific data can be feasibly collected in a public participation arrangement with minimal resources, making use of free and open source software in system design and digital communities in the collection of the data.