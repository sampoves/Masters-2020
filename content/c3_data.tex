...
\begin{hyphenrules}{nohyphenation}
    \begin{table}[H]
        \centering
        \setlength\tabcolsep{1pt}
        \caption{Utilised programming languages} 
        \label{tab:usedlangs}
        \begin{tabular}{ @{} >{\raggedright\arraybackslash}p{3cm} >{\raggedright\arraybackslash}p{3cm} >{\raggedright\arraybackslash}p{3cm} >{\raggedright\arraybackslash}p{3cm} >{\raggedleft\arraybackslash}p{2cm} @{} }
            ...
            \midrule
            HTML, CSS, JavaScript (NetBeans 8.2.0) & Web technologies which enable interactive web sites & Research survey programming & ECMA\footnotemark, W3C, WHATWG, Apache Software Foundation, Oracle Corporation & 2 \\
            Python 3.7.6, Anaconda 2020.02 (Spyder 4.0.1) & Anaconda is a Python programming language distribution for scientific computing & Survey data processing & Python Software Foundation, Anaconda, Inc., Spyder Project contributors & 2 \\
            R for Windows 3.6.3 (RStudio 1.2.5033) & Programming language environment for statistical computing & Survey data analysis and visualisation & R Core Team, RStudio, Inc. & 2 \\
            \bottomrule
        \end{tabular}
    \end{table} 
\end{hyphenrules}
...
\begin{hyphenrules}{nohyphenation}
    \begin{table}[H]
        ...
        \begin{tabular}{ @{} >{\raggedright\arraybackslash}p{3cm} >{\raggedright\arraybackslash}p{3cm} >{\raggedright\arraybackslash}p{3cm} >{\raggedright\arraybackslash}p{3cm} >{\raggedleft\arraybackslash}p{2cm} @{} }
            ...
            \midrule
            JavaScript & Leaflet 1.4.0 & Web mapping backbone of the research survey & Vladimir Agafonkin & 2 \\
            Python & pandas 1.0.1 & Data analysis and manipulation & Pandas contributors & \cite{McKinney2011Pandas:Statistics} \\
                & GeoPandas 0.5.0 & Adds Geographic data support to pandas objects & GeoPandas contributors & 2 \\
                & Shapely 1.6.4.post1 & Geometric objects, predicates, and operations & Apache Software Foundation & 2 \\
                & rtree 0.8.3 & Spatial indexing & Apache Software Foundation & 2 \\
            R & Shiny 1.4.0 & Web application framework for R & Vladimir Agafonkin & \cite{Chang2019Shiny:R} \\
                & dygraphs 1.1.1.6 & Interactive time series charting & Vladimir Agafonkin & 2 \\
                & ggplot2 3.3.0 & Data Visualisation & Vladimir Agafonkin & 2 \\
                & ggiraph 0.7.0 & Interactive ggplot2 graphics & Vladimir Agafonkin & 2 \\
            \bottomrule
        \end{tabular}
    \end{table} 
\end{hyphenrules}
...
\begin{figure}[H]%
    \centering
    \subfloat[label 1]{{\includegraphics[width=5.5cm]{survey123_1.png} }}%
    \subfloat[label 2]{{\includegraphics[width=5.5cm]{survey123_2.png} }}%
    \subfloat[label 3]{{\includegraphics[width=5.5cm]{survey123_3.png} }}%
    \caption{An example parking event entered into the unused parking research survey made with Survey123 Connect.}%
    \label{fig:survey123}%
\end{figure}
