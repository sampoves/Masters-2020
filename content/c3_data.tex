...
To answer this research question, the travel time comparison application was programmed. In this application, the user can view multiple descriptive values calculated from Helsinki Region Travel Time Matrix 2018, the thesis survey data, and a dataset created by comparing the two other datasets. 

\textcolor{green}{tilanne 250720}
