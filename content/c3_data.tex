...
\begin{hyphenrules}{nohyphenation}
    \begin{table}[H]
        ...
        \begin{tabular}{ @{} >{\raggedright\arraybackslash}p{2.5cm} >{\raggedright\arraybackslash}p{3cm} >{\raggedright\arraybackslash}p{4cm} >{\raggedleft\arraybackslash}p{3cm} @{} }
            ...
            \midrule
            \multirow{3}{*}{JavaScript} & Leaflet 1.4.0 & Web mapping library for the research survey & \cite{Agafonkin2019} \\
...
\textcolor{red}{huom, aineiston alkuperäiset yhdistelmäluokat poistettu/yhdistetty, muista mainita data processingissa}
