...
\begin{figure}[H]%
    ...
    \caption[Calculated zones of urban structure in the study area]{Each postal code area was assigned to belong to a group in the variable \code{ykr\_zone}, explained in table~\ref{tab:ykr_zones_simplify}, according to which group was largest in area in any given postal code area.\textcolor{red}{need larger font, remove decimal}}%
