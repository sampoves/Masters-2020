...
\textcolor{red}{kappaleen pituus ei lopullinen, kuvat eri layereista?} Paavo chapter

Urban Atlas chapter

YKR zones chapter

TTM18 metropaccess-grid chapter

Subdivisions chapter

Regional population density chapter
...
\textcolor{red}{kappaleen pituus ei lopullinen} A wide variety of software was used in this thesis. The research survey application utilised JavaScript, HTML, CSS and PHP. Using the web mapping library Leaflet, a modern and easy-to-use survey application was created. Server-side, the programming language PHP was used to verify received records. 

Data processing was completed using Python and R, with most of the processing done in Python and analysis and visualisation in R.
