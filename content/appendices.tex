...
\begin{longtable}{llll}
    ...
    \hline\hline
    \endhead % all lines above this command will be repeated on every page
    ...
    % caption should be on top for tables. Can't do that because the caption is duplicated for all longtable pages and that counts the table of contents as well.
