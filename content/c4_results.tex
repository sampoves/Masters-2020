...
\begin{hyphenrules}{nohyphenation}
    \begin{table}[H]
        ...
        \def\arraystretch{1.2}
        \setlength\tabcolsep{1.2ex}
        \caption[Parking process significance]{Significance of the parking process in example travel chains.}
        \label{tab:comparison_parkingprocess_signif}
        \scalebox{0.8}
        {\begin{tabular}{ @{} >{\raggedright\arraybackslash}p{5cm} >{\raggedright\arraybackslash}p{2cm} >{\raggedright\arraybackslash}p{2cm} >{\raggedright\arraybackslash}p{2.5cm} >{\raggedright\arraybackslash}p{2.5cm} @{} }
            \toprule
            Travel chain origin, example postal code area & Time of day & Destination municipality & Mean parking process duration (min) & Parking process share of the total travel chain (\%) \\
            \midrule
            \multirow{16}{4cm}{00150 Eira - Hernesaari (Center walking zone)} & \multirow{5}{*}{Rush hour} & Helsinki & & val \\
            & & Espoo & & val \\
            & & Vantaa & & val \\
            & & Kauniainen & & val \\
            \arrayrulecolor{black!30}\cmidrule(lr){3-5}
            & & all & & val \\
            \arrayrulecolor{black!30}\cmidrule(lr){2-5}
            
            & \multirow{5}{*}{Midday} & Helsinki & & val \\
            & & Espoo & & val \\
            & & Vantaa & & val \\
            & & Kauniainen & & val \\
            \arrayrulecolor{black!30}\cmidrule(lr){3-5}
            ...
            & \multirow{5}{*}{All values} & Helsinki & & val \\
            & & Espoo & & val \\
            & & Vantaa & & val \\
            & & Kauniainen & & val \\
            \arrayrulecolor{black!30}\cmidrule(lr){3-5}
            ...
            00520 Itä-Pasila (Center periphery zone) & & & & 7306 \\
            \greyrule
            02650 Pohjois-Leppävaara (Subcenter walking zone) & & & & 10595 \\
            \greyrule
            00640 Oulunkylä-Patola (Intensive transit zone) & & & & 8171 \\
            \greyrule
            00430 Maununneva (Transit zone) & & & & 5454 \\ 
            \greyrule
            02920 Niipperi (Automobile zone) & & & & 5347 \\
            \greyrule
            01690 Ylästö (novalue) & & & & 4787 \\
            \bottomrule
        \end{tabular}}
    \end{table}
\end{hyphenrules}
...
\begin{hyphenrules}{nohyphenation}
    \begin{table}[H]
        \centering
        \caption[Parking process significance]{Significance of the parking process in example travel chains.}
        \label{tab:comparison_parkingprocess_signif2}
        \scalebox{0.9}
        {\begin{tabular}{>{\raggedleft\arraybackslash}p{4cm} lccCccc}
            ...
            \midrule
            \multirow{5}{4cm}{00150 Eira - Hernesaari (Center walking zone)} & Helsinki & --- & --- & --- & --- & --- & --- \\
            & Espoo &                                                           --- & --- & --- &   --- & --- & --- \\
