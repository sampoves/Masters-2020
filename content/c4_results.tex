\section{Results}
\label{sec:c4-results} % label to enable hyperref to this chapter
...
\begin{figure}[H]%
    \centering
    \includegraphics[width=\textwidth]{images/hist_pmax59-wmax59_parktime-likert_binw2_15-10-2020.png}
    \caption[Histogram, searching for parking]{All thesis survey \code{parktime} values (< 60) shown on histogram.}%
    \label{fig:parktime_hist}%
\end{figure}

\begin{figure}[H]%
    \centering
    \includegraphics[width=\textwidth]{images/hist_pmax59-wmax59_walktime-likert_binw2_15-10-2020.png}
    \caption[Histogram, walk to destination]{All thesis survey \code{walktime} values (< 60) shown on histogram.}%
...
% A known issue with these maps: Vartiosaari is represented. As an unreachable island, it shouldn't.
\begin{figure}[H]%
    \centering
...
When comparing specific subdivisions, we can observe finer details in the survey dataset. For example, comparing \code{parktime} in Espoo's Suur-Tapiola and Vantaa's Aviapolis gives no statistical significance with \acrshort{anova} ($F = 2.412$, $p = 0.121$). However, a test with Suur-Tapiola and Helsinki's Southern subdivision is statistically significant ($F = 88.272$, $p < 0.001$, ’***’). It is interesting, that an \acrshort{anova} \code{parktime} comparison of Espoo's Suur-Leppävaara and Helsinki's Northeastern subdivisions -- both important subcenters of their respective cities -- produces no statistical significance ($F = 0.036$, $p = 0.850$). 

Differences of Espoo's Vanha-Espoo and Helsinki's Östersundom subdivisions viewed with \code{walktime} gives a faint statistical significance with \acrshort{anova} ($F = 3.807$, $p = 0.054$, '.'). Testing areas with contrasting features, Vanha-Espoo and Vantaa's Tikkurila proved statistically significant ($F = 8.258$, $p = 0.004$, '**'). It is interesting that important city centers receive different results from the \acrshort{anova} test. For example, differences in \code{walktime} are statistically significant ($F = 36.168$, $p \leq 0.001$, ’***’) between Vantaa's Myyrmäki and Tikkurila subdivisions. \code{walktime} differences of Espoo's Suur-Matinkylä and Suur-Leppävaara are not ($F = 2.277$, $p = 0.132$). The same case stands for Helsinki's Southeastern and Western subdivisions of which differences were not identified as statistically significant ($F = 0.091$, $p = 0.762$). However, varying degrees of significance is found for the same subdivision comparison pairs when using \code{parktime} as the explanatory variable: Myyrmäki--Tikkurila achieves high statistical significance ($F = 23.299$, $p \leq 0.001$, ’***’), while Suur-Matinkylä--Suur-Leppävaara ($F = 7.296$, $p = 0.007$, '**'), and Southeastern--Western ($F = 7.218$, $p = 0.007$, '**') get moderate significance.
...
\begin{hyphenrules}{nohyphenation}
    \begin{table}[H]
        ...
        {\begin{tabular}{clLccccCcccccc}
            ...
            \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{746} & \multirow{2}{*}{2} & \multirow{2}{*}{3.23} & \multirow{2}{*}{3.63} & \multirow{2}{*}{0.13} & 2.646, & \multirow{2}{*}{2} & \multirow{2}{*}{3.52} & \multirow{2}{*}{3.09} & \multirow{2}{*}{0.11} & 4.647, \\
            & & & & & & & 0.015 (*) & & & & & < 0.001 (***) \\
            ...
            \arrayrulecolor{black!30}\cmidrule(lr){2-13}
            \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{3777} & \multirow{2}{*}{4} & \multirow{2}{*}{5.24} & \multirow{2}{*}{5.60} & \multirow{2}{*}{0.09} & 53.823, & \multirow{2}{*}{4} & \multirow{2}{*}{4.78} & \multirow{2}{*}{4.10} & \multirow{2}{*}{0.07} & 47.497, \\
            & & & & & & & < 0.001 (***) & & & & & < 0.001 (***) \\
            \arrayrulecolor{black}\midrule
            ...
            \arrayrulecolor{black!30}\cmidrule(lr){2-13}
            \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{637} & \multirow{2}{*}{2} & \multirow{2}{*}{3.82} & \multirow{2}{*}{4.65} & \multirow{2}{*}{0.18} & 6.218, & \multirow{2}{*}{3} & \multirow{2}{*}{3.98} & \multirow{2}{*}{4.11} & \multirow{2}{*}{0.16} & 9.565, \\
            & & & & & & & < 0.001 (***) & & & & & < 0.001 (***) \\
            \arrayrulecolor{black}\midrule
            
            \multirow{2}{*}{All} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{5183} & \multirow{2}{*}{3} & \multirow{2}{*}{4.76} & \multirow{2}{*}{5.29} & \multirow{2}{*}{0.07} & 27.123, & \multirow{2}{*}{3} & \multirow{2}{*}{4.49} & \multirow{2}{*}{3.99} & \multirow{2}{*}{0.06} & 23.767, \\
            & & & & & & & < 0.001 (***) & & & & & < 0.001 (***) \\
            \bottomrule
        \end{tabular}}
    \end{table}
...
The one-way \acrshort{anova} test yielded varying results when comparing choices of \code{timeofday} inside the municipalities of Helsinki Capital Region. Highly significant differences between the time of the the day of parking and the response variables were only detected in Helsinki, where the significant results of $F = 5.913$, $p \leq 0.001$ (\code{parktime}), and $F = 6.808$, $p \leq 0.001$ (\code{walktime}) were reached. The corresponding test for Espoo produced a weaker statistical significance with \code{parktime} ($F = 2.857$, $p = 0.036$, '*') and \code{walktime} ($F = 3.121$, $p = 0.02$, '*'). The \acrshort{anova} test results for Kauniainen were entirely non-significant while Vantaa's \acrshort{anova} test results produced a non-significant result for \code{parktime} and a weak statistical significance for \code{walktime} ($F = 6.372$, $p = 0.067$, '.').
...
\begin{hyphenrules}{nohyphenation}
    \begin{table}[H]
        ...
        {\begin{tabular}{clLccccCcccccc}
            ...
            \arrayrulecolor{black!30}\cmidrule(lr){2-13}
            \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{746} & \multirow{2}{*}{2} & \multirow{2}{*}{3.23} & \multirow{2}{*}{3.63} & \multirow{2}{*}{0.13} & 2.857, & \multirow{2}{*}{2} & \multirow{2}{*}{3.52} & \multirow{2}{*}{3.09} & \multirow{2}{*}{0.11} & 3.121, \\
            & & & & & & & 0.036 (*) & & & & & 0.025 (*) \\
            \arrayrulecolor{black}\midrule
            ...
            \arrayrulecolor{black!30}\cmidrule(lr){2-13}
            \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{3777} & \multirow{2}{*}{4} & \multirow{2}{*}{5.24} & \multirow{2}{*}{5.60} & \multirow{2}{*}{0.09} & 5.913, & \multirow{2}{*}{4} & \multirow{2}{*}{4.78} & \multirow{2}{*}{4.10} & \multirow{2}{*}{0.07} & 6.808, \\
            & & & & & & & < 0.001 (***) & & & & & < 0.001 (***) \\
            \arrayrulecolor{black}\midrule
            ...
            \arrayrulecolor{black!30}\cmidrule(lr){2-13}
            \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{23} & \multirow{2}{*}{2} & \multirow{2}{*}{2.13} & \multirow{2}{*}{1.60} & \multirow{2}{*}{0.33} & 1.669, & \multirow{2}{*}{2} & \multirow{2}{*}{2.22} & \multirow{2}{*}{1.28} & \multirow{2}{*}{0.27} & 0.893, \\
            & & & & & & & 0.207 ($ns$) & & & & & 0.463 ($ns$) \\
            \arrayrulecolor{black}\midrule
            ...
            \arrayrulecolor{black!30}\cmidrule(lr){2-13}
            \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{637} & \multirow{2}{*}{2} & \multirow{2}{*}{3.82} & \multirow{2}{*}{4.65} & \multirow{2}{*}{0.18} & 0.929, & \multirow{2}{*}{3} & \multirow{2}{*}{3.98} & \multirow{2}{*}{4.11} & \multirow{2}{*}{0.16} & 2.399, \\
            & & & & & & & < 0.426 ($ns$) & & & & & < 0.067 (.) \\
            \arrayrulecolor{black}\midrule
            
            \multirow{2}{*}{All} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{5183} & \multirow{2}{*}{3} & \multirow{2}{*}{4.76} & \multirow{2}{*}{5.29} & \multirow{2}{*}{0.07} & 5.801, & \multirow{2}{*}{3} & \multirow{2}{*}{4.49} & \multirow{2}{*}{3.99} & \multirow{2}{*}{0.06} & 6.372, \\
            & & & & & & & < 0.001 (***) & & & & & < 0.001 (***) \\
            \bottomrule
        \end{tabular}}
    \end{table}
...
The one-way \acrshort{anova} test for the explanatory variable \code{parkspot} and response variables \code{parktime} and \code{walktime} showed strong statistical significance for differences between parking spot types and study area municipalities. However, while the three largest study area municipalities had this state (Helsinki, Espoo, and Vantaa), Kauniainen received non-significant results from the \acrshort{anova} test for both \code{parktime} and \code{walktime}. In the cases of all study area municipalities, a better significance for differences between \code{parkspot} groups could be attained by excluding the group \textit{Other}, if only slightly. When testing with a more limited set of \textit{parkspot} groups, such as only testing differences of \textit{Parking lot} and \textit{Parking garage}, all statistical significance would be lost with the exception of Espoo, where statistical significance for the differences would position at $F = 5.266$, $p = 0.022$ ('*'). All municipalities except Kauniainen would also receive substantial statistical significance when testing for differences between the group \textit{On the side of street} and \textit{Private or reserved} ($F = 28.410$ in Espoo, $F = 126.548$ in Helsinki, and $F = 24.910$ in Vantaa, and all municipalities shared $p \leq 0.001$, '***').
...
\begin{hyphenrules}{nohyphenation}
    \begin{table}[H]
        ...
        {\begin{tabular}{clLccccCcccccc}
            ...
            \arrayrulecolor{black!30}\cmidrule(lr){2-13}
            \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{746} & \multirow{2}{*}{2} & \multirow{2}{*}{3.23} & \multirow{2}{*}{3.63} & \multirow{2}{*}{0.13} & 8.323, & \multirow{2}{*}{2} & \multirow{2}{*}{3.52} & \multirow{2}{*}{3.09} & \multirow{2}{*}{0.11} & 5.750, \\
            & & & & & & & < 0.001 (***) & & & & & < 0.001 (***) \\
            \arrayrulecolor{black}\midrule
            ...
            \arrayrulecolor{black!30}\cmidrule(lr){2-13}
            \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{3777} & \multirow{2}{*}{4} & \multirow{2}{*}{5.24} & \multirow{2}{*}{5.60} & \multirow{2}{*}{0.09} & 68.395, & \multirow{2}{*}{4} & \multirow{2}{*}{4.78} & \multirow{2}{*}{4.10} & \multirow{2}{*}{0.07} & 29.022, \\
            & & & & & & & < 0.001 (***) & & & & & < 0.001 (***) \\
            \arrayrulecolor{black}\midrule
            ...
            \arrayrulecolor{black!30}\cmidrule(lr){2-13}
            \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{23} & \multirow{2}{*}{2} & \multirow{2}{*}{2.13} & \multirow{2}{*}{1.60} & \multirow{2}{*}{0.33} & 0.976, & \multirow{2}{*}{2} & \multirow{2}{*}{2.22} & \multirow{2}{*}{1.28} & \multirow{2}{*}{0.27} & 1.055, \\
            & & & & & & & 0.425 ($ns$) & & & & & 0.391 ($ns$) \\
            \arrayrulecolor{black}\midrule
            ...
            \arrayrulecolor{black!30}\cmidrule(lr){2-13}
            \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{637} & \multirow{2}{*}{2} & \multirow{2}{*}{3.82} & \multirow{2}{*}{4.65} & \multirow{2}{*}{0.18} & 9.437, & \multirow{2}{*}{3} & \multirow{2}{*}{3.98} & \multirow{2}{*}{4.11} & \multirow{2}{*}{0.16} & 7.354, \\
            & & & & & & & < 0.001 (***) & & & & & < 0.001 (***) \\
            \arrayrulecolor{black}\midrule
            
            \multirow{2}{*}{All} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{5183} & \multirow{2}{*}{3} & \multirow{2}{*}{4.76} & \multirow{2}{*}{5.29} & \multirow{2}{*}{0.07} & 111.008, & \multirow{2}{*}{3} & \multirow{2}{*}{4.49} & \multirow{2}{*}{3.99} & \multirow{2}{*}{0.06} & 51.508, \\
            & & & & & & & < 0.001 (***) & & & & & < 0.001 (***) \\
            \bottomrule
        \end{tabular}}
    \end{table}
...
\begin{hyphenrules}{nohyphenation}
    \begin{table}[H]
        ...
        {\begin{tabular}{clLccccCcccccc}
            ...
            \arrayrulecolor{black!30}\cmidrule(lr){2-13}
            \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{746} & \multirow{2}{*}{2} & \multirow{2}{*}{3.23} & \multirow{2}{*}{3.63} & \multirow{2}{*}{0.13} & 3.936, & \multirow{2}{*}{2} & \multirow{2}{*}{3.52} & \multirow{2}{*}{3.09} & \multirow{2}{*}{0.11} & 3.375, \\
            & & & & & & & 0.004 (**) & & & & & 0.009 (**) \\
            \arrayrulecolor{black}\midrule
            ...
            \arrayrulecolor{black!30}\cmidrule(lr){2-13}
            \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{3777} & \multirow{2}{*}{4} & \multirow{2}{*}{5.24} & \multirow{2}{*}{5.60} & \multirow{2}{*}{0.09} & 7.508, & \multirow{2}{*}{4} & \multirow{2}{*}{4.78} & \multirow{2}{*}{4.10} & \multirow{2}{*}{0.07} & 18.793, \\
            & & & & & & & < 0.001 (***) & & & & & < 0.001 (***) \\
            \arrayrulecolor{black}\midrule
            ...
            \arrayrulecolor{black!30}\cmidrule(lr){2-13}
            \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{23} & \multirow{2}{*}{2} & \multirow{2}{*}{2.13} & \multirow{2}{*}{1.60} & \multirow{2}{*}{0.33} & 1.025, & \multirow{2}{*}{2} & \multirow{2}{*}{2.22} & \multirow{2}{*}{1.28} & \multirow{2}{*}{0.27} & 0.309, \\
            & & & & & & & 0.421 ($ns$) & & & & & 0.868 ($ns$) \\
            \arrayrulecolor{black}\midrule
            ...
            \arrayrulecolor{black!30}\cmidrule(lr){2-13}
            \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{637} & \multirow{2}{*}{2} & \multirow{2}{*}{3.82} & \multirow{2}{*}{4.65} & \multirow{2}{*}{0.18} & 1.114, & \multirow{2}{*}{3} & \multirow{2}{*}{3.98} & \multirow{2}{*}{4.11} & \multirow{2}{*}{0.16} & 1.817, \\
            & & & & & & & 0.349 ($ns$) & & & & & 0.124 ($ns$) \\
            \arrayrulecolor{black}\midrule
            
            \multirow{2}{*}{All} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{5183} & \multirow{2}{*}{3} & \multirow{2}{*}{4.76} & \multirow{2}{*}{5.29} & \multirow{2}{*}{0.07} & 10.132, & \multirow{2}{*}{3} & \multirow{2}{*}{4.49} & \multirow{2}{*}{3.99} & \multirow{2}{*}{0.06} & 20.354, \\
            & & & & & & & < 0.001 (***) & & & & & < 0.001 (***) \\
            \bottomrule
        \end{tabular}}
    \end{table}
...
The explanatory variable \code{parktime} values follow a descending trend from the most intensively built group \textit{Fully built} to the group representing areas of most scattered urban features, \textit{Scarcely built}. In Helsinki, parking one's car took longest in the areas designated \textit{Predominantly built} (mean 5.4 minutes, median 5.0 minutes), with \textit{Fully built} following as the second longest (5.3, 4.0 min). In Espoo and Vantaa, the longest parking times could be found in fully built areas (Espoo's mean 3.6 minutes, median 2.0 minutes, while in Vantaa corresponding values were 5.1 minutes and 4.0 minutes).
...
As for the \acrshort{anova} test, \code{artificial} produces strong statistical significances for differences between groups in applicable municipalities, but not for all municipalities. For example, the p value for Helsinki's \code{walktime} received $F = 2.009$ and $p \leq 0.090$ (.), a weak result compared to other variables and municipalities. Comparing specific groups instead of all of them, statistically significant sections could be identified most frequently in Vantaa. For example, there is a $p \leq 0.001$ ('***') statistical significance between the differences of the groups \textit{Fully built} and \textit{Some built}. This was true for both \code{parktime} ($F = 19.293$) and \code{walktime} ($F = 24.186$). In contrast, testing \textit{Fully built}--\textit{Scarcely built} gives non-significant results for both \code{parktime} ($F = 0.015$, $p = 0.902$) and \code{walktime} ($F = 0.035$, $p = 0.851$) in Vantaa.
...
\begin{hyphenrules}{nohyphenation}
    \begin{table}[H]
        ...
        {\begin{tabular}{clLccccCcccccc}
            ...
            \arrayrulecolor{black!30}\cmidrule(lr){2-13}
            \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{746} & \multirow{2}{*}{2} & \multirow{2}{*}{3.23} & \multirow{2}{*}{3.63} & \multirow{2}{*}{0.13} & 3.237, & \multirow{2}{*}{2} & \multirow{2}{*}{3.52} & \multirow{2}{*}{3.09} & \multirow{2}{*}{0.11} & 4.431,
            \\
            & & & & & & & 0.012 (*) & & & & & 0.001 (**) \\
            \arrayrulecolor{black}\midrule
            ...
            \arrayrulecolor{black!30}\cmidrule(lr){2-13}
            \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{3777} & \multirow{2}{*}{4} & \multirow{2}{*}{5.24} & \multirow{2}{*}{5.60} & \multirow{2}{*}{0.09} & 6.097, & \multirow{2}{*}{4} & \multirow{2}{*}{4.78} & \multirow{2}{*}{4.10} & \multirow{2}{*}{0.07} & 2.009, \\
            & & & & & & & < 0.001 (***) & & & & & 0.090 (.) \\
            \arrayrulecolor{black}\midrule
            ...
            \arrayrulecolor{black!30}\cmidrule(lr){2-13}
            \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{637} & \multirow{2}{*}{2} & \multirow{2}{*}{3.82} & \multirow{2}{*}{4.65} & \multirow{2}{*}{0.18} & 7.587, & \multirow{2}{*}{3} & \multirow{2}{*}{3.98} & \multirow{2}{*}{4.11} & \multirow{2}{*}{0.16} & 15.331, \\
            & & & & & & & < 0.001 (***) & & & & & < 0.001 (***) \\
            \arrayrulecolor{black}\midrule
            
            \multirow{2}{*}{All} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{5183} & \multirow{2}{*}{3} & \multirow{2}{*}{4.76} & \multirow{2}{*}{5.29} & \multirow{2}{*}{0.07} & 18.333, & \multirow{2}{*}{3} & \multirow{2}{*}{4.49} & \multirow{2}{*}{3.99} & \multirow{2}{*}{0.06} & 11.757, \\
            & & & & & & & < 0.001 (***) & & & & & < 0.001 (***) \\
            \bottomrule
        \end{tabular}}
    \end{table}
...
\begin{hyphenrules}{nohyphenation}
    \begin{table}[H]
        ...
        {\begin{tabular}{clLccccCcccccc}
            ...
            \arrayrulecolor{black!30}\cmidrule(lr){2-13}
            \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{746} & \multirow{2}{*}{2} & \multirow{2}{*}{3.23} & \multirow{2}{*}{3.63} & \multirow{2}{*}{0.13} & 8.040, & \multirow{2}{*}{2} & \multirow{2}{*}{3.52} & \multirow{2}{*}{3.09} & \multirow{2}{*}{0.11} & 8.026, \\
            & & & & & & & < 0.001 (***) & & & & & < 0.001 (***) \\
            \arrayrulecolor{black}\midrule
            ...
            \arrayrulecolor{black!30}\cmidrule(lr){2-13}
            \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{3777} & \multirow{2}{*}{4} & \multirow{2}{*}{5.24} & \multirow{2}{*}{5.60} & \multirow{2}{*}{0.09} & 77.835, & \multirow{2}{*}{4} & \multirow{2}{*}{4.78} & \multirow{2}{*}{4.10} & \multirow{2}{*}{0.07} & 64.204, \\
            & & & & & & & < 0.001 (***) & & & & & < 0.001 (***) \\
            \arrayrulecolor{black}\midrule
            ...
            \arrayrulecolor{black!30}\cmidrule(lr){2-13}
            \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{637} & \multirow{2}{*}{2} & \multirow{2}{*}{3.82} & \multirow{2}{*}{4.65} & \multirow{2}{*}{0.18} & 4.001, & \multirow{2}{*}{3} & \multirow{2}{*}{3.98} & \multirow{2}{*}{4.11} & \multirow{2}{*}{0.16} & 7.475, \\
            & & & & & & & 0.003 (**) & & & & & < 0.001 (***) \\
            \arrayrulecolor{black}\midrule
            
            \multirow{2}{*}{All} & \multirow{2}{*}{\textbf{Total}} & \multirow{2}{*}{5183} & \multirow{2}{*}{3} & \multirow{2}{*}{4.76} & \multirow{2}{*}{5.29} & \multirow{2}{*}{0.07} & 112.502, & \multirow{2}{*}{3} & \multirow{2}{*}{4.49} & \multirow{2}{*}{3.99} & \multirow{2}{*}{0.06} & 88.815, \\
            & & & & & & & < 0.001 (***) & & & & & < 0.001 (***) \\
            \bottomrule
        \end{tabular}}
    \end{table}
...
\begin{hyphenrules}{nohyphenation}
    \begin{table}[H]
        ...
        {\begin{tabular}{>{\raggedleft\arraybackslash}p{4cm} lccCccCccc}
            ...
            \midrule
            \multirow{7}{4cm}{00150 Eira - Hernesaari (Center walking zone)} & 00150 & 5.12 & 4.68 & 4.48 & 11.25 & 17.40 & 14.16 & 220* & 372* & 316*
 \\
            ...
            \multirow{7}{4cm}{00520 Itä-Pasila (Center periphery zone)} & 00150 & 22.89 & 18.87 & 17.38 & 11.25 & 17.40 & 14.16 & 49 & 92 & 81 \\
            ...
            \multirow{7}{4cm}{02650 Pohjois-Leppävaara (Subcenter walking zone)} & 00150 & 34.28 & 29.42 & 26.46 & 11.25 & 17.40 & 14.16 & 33 & 59 & 54 \\
            ...
            \multirow{7}{4cm}{00640 Oulunkylä-Patola (Intensive transit zone)} & 00150 & 35.33 & 29.62 & 27.06 & 11.25 & 17.40 & 14.16 & 32 & 59 & 52 \\
            ...
            \multirow{7}{4cm}{00430 Maununneva (Transit zone)} & 00150 & 38.60 & 32.89 & 29.82 & 11.25 & 17.40 & 14.16 & 29 & 53 & 47 \\
            ...
            \multirow{7}{4cm}{02920 Niipperi (Automobile zone)} & 00150 & 54.19 & 44.85 & 41.98 & 11.25 & 17.40 & 14.16 & 21 & 39 & 34 \\
            ...
            \multirow{7}{4cm}{01690 Ylästö (novalue)} & 00150 & 48.65 & 41.47 & 37.90 & 11.25 & 17.40 & 14.16 & 23 & 42 & 37 \\
...
The proportion of the parking process from the starting postal code area of 00150 Eira-Hernesaari appears relatively even when viewing the survey data with equal intervals. The southern part of the peninsula of Helsinki accumulates the largest parking process shares. In the \code{pct} data, additionally, it is quite commonplace to end up in a situation where the calculated parking process duration is longer than the calculated \textit{Travel Time Matrix} mean driving time to a destination postal code area.
...
\begin{sidewaysfigure}
    \centering
    \includegraphics[trim={0.9cm 0.3cm 0.25cm 0.3cm},clip,width=\textwidth]{images/compare_traveltimes_mapfill-msc_r_pct_fromzip-00150_16-10-2020.png}
    \caption[Parking process proportion from Eira-Hernesaari, rush hour traffic]{The parking process proportion in the total travel chain, in rush hour traffic, starting from 00150 Eira-Hernesaari. SFP stands for \textit{searching for parking}, \code{parktime}, and WTD \textit{walking to destination}, \code{walktime}. These are the components of the parking process in the \textit{door-to-door approach}.}%
    \label{fig:compare_msc_r_pct_00150}%
\end{sidewaysfigure}

\begin{sidewaysfigure}
    \centering
    \includegraphics[trim={0.9cm 0.3cm 0.25cm 0.3cm},clip,width=\textwidth]{images/compare_traveltimes_mapfill-msc_m_pct_fromzip-00150_16-10-2020.png}
...
\begin{sidewaysfigure}
    \centering
    \includegraphics[trim={0.9cm 0.3cm 0.25cm 0.3cm},clip,width=\textwidth]{images/compare_traveltimes_mapfill-msc_all_pct_fromzip-00150_16-10-2020.png}
...
If all available temporal data is employed in thesis survey data and the \textit{Travel Time Matrix}, extreme values recorded in \code{parktime} and \code{walktime} are honed away and a rough circular shape of long parking process shares may be observed around 00640 Oulunkylä-Patola (figure~\ref{fig:compare_msc_all_pct_00640}). Using this variable, the majority of the center of Helsinki receives parking process shares of more than 60 \%. In general, most of the largest parking process shares are located inside the Ring I beltway with the exception of Vantaa's 01300 Tikkurila (76 \%) and 01530 Veromiehenkylä (71 \%).

\newgeometry{left=2cm, right=1cm, top=2.5cm, bottom=2.5cm}
\begin{sidewaysfigure}
    \centering
    \includegraphics[trim={0.9cm 0.3cm 0.25cm 0.3cm},clip,width=\textwidth]{images/compare_traveltimes_mapfill-msc_r_pct_fromzip-00640_16-10-2020.png}
    \caption[Parking process proportion from Oulunkylä-Patola, rush hour traffic]{The parking process proportion in the total travel chain, in rush hour traffic, starting from 00640 Oulunkylä-Patola. SFP stands for \textit{searching for parking}, \code{parktime}, and WTD \textit{walking to destination}, \code{walktime}. These are the components of the parking process in the \textit{door-to-door approach}.}%
    \label{fig:compare_msc_r_pct_00640}%
\end{sidewaysfigure}

\begin{sidewaysfigure}
    \centering
    \includegraphics[trim={0.9cm 0.3cm 0.25cm 0.3cm},clip,width=\textwidth]{images/compare_traveltimes_mapfill-msc_m_pct_fromzip-00640_16-10-2020.png}
...
\begin{sidewaysfigure}
    \centering
    \includegraphics[trim={0.9cm 0.3cm 0.25cm 0.3cm},clip,width=\textwidth]{images/compare_traveltimes_mapfill-msc_all_pct_fromzip-00640_16-10-2020.png}
...
\begin{sidewaysfigure}
    \centering
    \includegraphics[trim={0.9cm 0.3cm 0.25cm 0.3cm},clip,width=\textwidth]{images/compare_traveltimes_mapfill-msc_r_pct_fromzip-02920_16-10-2020.png}
    \caption[Parking process proportion from Niipperi, rush hour traffic]{The parking process proportion in the total travel chain, in rush hour traffic, starting from 02920 Niipperi. SFP stands for \textit{searching for parking}, \code{parktime}, and WTD \textit{walking to destination}, \code{walktime}. These are the components of the parking process in the \textit{door-to-door approach}.}%
    \label{fig:compare_msc_r_pct_02920}%
\end{sidewaysfigure}

\begin{sidewaysfigure}
    \centering
    \includegraphics[trim={0.9cm 0.3cm 0.25cm 0.3cm},clip,width=\textwidth]{images/compare_traveltimes_mapfill-msc_m_pct_fromzip-02920_16-10-2020.png}
...
\begin{sidewaysfigure}
    \centering
    \includegraphics[trim={0.9cm 0.3cm 0.25cm 0.3cm},clip,width=\textwidth]{images/compare_traveltimes_mapfill-msc_all_pct_fromzip-02920_16-10-2020.png}
