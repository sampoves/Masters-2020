...
% citeaikomus: Central limit theorem: the cornerstone of modern statistics: https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5370305/
\textcolor{red}{varmista tämä CLT} \\
In this study, I consider the normality assumption of \acrshort{anova} satisfied on the grounds of the central limit theorem. In central limit theorem, with sample sizes large enough, sample mean of distribution of any shape will tend toward a normal distribution.
