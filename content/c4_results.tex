...
\begin{figure}[H]%
    ...
    \caption[Parktime, mean, in the reseach area]{This figure illustrates the mean duration (minutes) of searching for parking and parking one's car in each postal code area.}%
...
\begin{figure}[H]%
    ...
    \caption[Parktime, median, in the reseach area]{This figure illustrates the median duration (minutes) of searching for parking and parking one's car in each postal code area.}%
...
\begin{figure}[H]%
    ...
    \caption[Walktime, mean, in the research area]{This figure illustrates the mean duration (minutes) of walking from one's parked car to the final destination in each postal code area.}%
...
\begin{figure}[H]%
    ...
    \caption[Walktime, median, in the research area]{This figure illustrates the median duration (minutes) of walking from one's parked car to the final destination in each postal code area.}%
...
The one-way \acrshort{anova} test yielded varying results when comparing choices of \code{timeofday} inside the municipalities of Helsinki Capital Region. Highly significant differences between the time of the the day of parking and walking from one's car to the final destination were only detected in Helsinki, where the significant results of $F = 5.913$, $p \leq 0.001$ (\code{parktime}), and $F = 6.808$, $p \leq 0.001$ (\code{walktime}) were reached. The corresponding test for Espoo produced a weaker statistical significance with \code{parktime} ($F = 2.857$, $p = 0.036$, '*') and \code{walktime} ($F = 3.121$, $p = 0.02$, '*'). The \acrshort{anova} tests were entirely non-significant while Vantaa's \acrshort{anova} test testing \code{timeofday} produced a non-significant result for \code{parktime} and a weak significance for \code{walktime} ($F = 6.372$, $p = 0.067$, '.').
