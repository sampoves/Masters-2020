...
The selected postal code areas represent functionally different parts of the research area. 00150 Eira-Hernesaari (Center walking zone) is located at the southern tip of Helsinginniemi where all possible exit options are time intensive for the private car. 00540 Oulunkylä-Patola (Intensive transit zone) is closer to the major road infrastructure of Helsinki Capital Region, namely the Ring I beltway and the Finnish national road 3 leading to Tampere. 02920 Niipperi (Automobile zone) is characterised as an area of detached housing where public transport coverage is scarce. It is then indicative to use these areas as representatives of the whole research area, as the breadth of the data the travel time comparison application is much too plentiful to be written out in tables or individual images.

Table~\ref{tab:comparison_parkingprocess_signif} presents the driving parts and parking process parts of several different example travel chains. In these examples, the parking process is a significant part of the travel chains. In most cases the parking process share diminishes the longer the travel chain is in duration and kilometers, but this driving to the center of Helsinki is an exception of this because of the long mean \code{parktime} and \code{walktime} values. When comparing the parking process length between thesis survey and the durations used in \textit{TTM}, thesis parking process can be up to six times longer than that of \textit{TTM}.
